...
To simplify the process, I have created a PowerShell script to create the Azure AD application for the ConfigMgr OMS Connector. The script is located in my GitHub repository: <a title="https://github.com/TaoYang-cloud/BlogPosts/tree/master/OMS" href="https://github.com/TaoYang-cloud/BlogPosts/tree/master/OMS">https://github.com/TaoYang-cloud/BlogPosts/tree/master/OMS</a>
