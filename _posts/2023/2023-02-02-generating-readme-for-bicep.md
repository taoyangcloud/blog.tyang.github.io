...
You can find the script `generateBicepReadme.ps1`[here](https://github.com/TaoYang-cloud/BlogPosts/blob/master/Scripts/psDocs/generateBicepReadme.ps1)
...
This example can be found in my GitHub repo [here](https://github.com/TaoYang-cloud/BlogPosts/tree/master/Azure-Bicep/vnet-isolated-cloud-shell)
